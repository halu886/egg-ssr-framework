...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("router-view"),
      _vm._ssrNode('<div class="links">', "</div>", [
        _vm._ssrNode(
          "<div>",
          "</div>",
          [_c("router-link", { attrs: { to: "top" } }, [_vm._v("Go to Top")])],
          1
        ),
        _vm._ssrNode(
          "<div>",
          "</div>",
          [
            _c("router-link", { attrs: { to: "bottom" } }, [
              _vm._v("Go to Bottom")
            ])
          ],
          1
      ...
      _vm._ssrNode(
        '<div class="overview"><div class="main-show">SHOW</div><div class="vices">' +
